...
for($i = 1; $i <= 25; $i++)
{
        if(isset($_POST['squad' . $i]))
        {
           $_SESSION['squad' . $i] = $_POST['squad' . $i];
        }
}
?>
<!DOCTYPE html>
...
<body>
        ...
        <!-- form -->
        <div class="row">
        <form class="col s12 formulario" method="POST" action="adicionar-jogo2.php">
            <h5>Preencha com os dados do primeiro jogo </h5>
            <br>
            <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad1Jogo1" min="0" max="100" type="number">
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad2Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao2">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad3Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao3">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad4Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao4">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad5Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao5">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad6Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao6">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad7Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao7">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad8Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao8">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad9Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao9">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad10Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao10">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad11Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao11">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad12Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao12">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad13Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao13">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad14Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao14">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad15Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao15">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad16Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao16">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad17Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao17">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad18Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao18">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad19Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao19">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad20Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao20">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad21Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao21">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad22Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao22">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad23Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao23">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad24Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao24">
            </div>
        ...
        <div class='row'>
            ...
            <div class="input-field col s4">
            <input name="killSquad25Jogo1" min="0" max="100" type="number">
            <label for="last_name">Abates da equipe</label>
            </div>
            <div id="colocacao25">
            </div>
        ...
        <div class="row">
          <div class='input-field col s5'> 
            <a class="waves-effect waves-light btn" href="../pages/inserir-squad.php"><i class="material-icons left">arrow_back</i><b>voltar</b></a>
          </div>
          <div class='input-field col s7'> 
            <button class="waves-effect waves-light btn" type="submit"><i class="material-icons left">looks_one</i><b>Marcar Pontos</b></button>
          </div>
        </div>
        <br><br>      
        </form>
        </div>
<script src="../scripts/adicionar-jogo1.js"></script>
